...
import { react_modal_images__modal_contentSvg } from './styles';
...
export const SpinnerIcon: React.FC = () => {
    return (
        <svg fill="#ffffff" height="48" viewBox="0 0 24 24" width="48" xmlns="http://www.w3.org/2000/svg" style={react_modal_images__modal_contentSvg}>
